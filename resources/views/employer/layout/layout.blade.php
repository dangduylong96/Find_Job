...
<html>
    <head>
        ...
        <title>Quản trị nhà tuyển dụng</title>
        ...
        <!--[if lt IE 9]>
        <script src="{{asset('public/admin/https://oss.maxcdn.com/html5shiv/3.7.3/html5shiv.min.js')}}"></script>
        ...
        <div class="wrapper">
            <header class="main-header">
                ...
                <a href="#" class="logo">
                    ...
                    <span class="logo-mini"><b>Tìm Việc Nhanh</b></span>
                    <!-- logo for regular state and mobile devices -->
                    <span class="logo-lg"><b>Tìm Việc</b>Nhanh</span>
                </a>
