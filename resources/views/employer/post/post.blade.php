                    ...
                    <form class="form-horizontal" action="{{route('post_add_employer')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input name="title" type="text" class="form-control" placeholder="Tiêu đề tuyển dụng" value="{{old('title')}}" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input name="qty_candidate" type="number" class="form-control" id="address" placeholder="Số lượng" value="{{old('qty_candidate')}}" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select id="sex" name="sex" class="form-control select2" style="width: 100%;">
                                        ...
                                        <option value="{{$k}}" {{(old("sex") == $k ? "selected":"") }}>{{$v}}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="box-footer">
                            <button type="submit" class="btn btn-success btn-block">Đăng Tin</button>
                        </div>
                        <!-- /.box-footer -->
                    </form>
                </div>
