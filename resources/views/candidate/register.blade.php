    ...
    <body class="hold-transition register-page">
        <div class="register-box">
            <div class="register-logo">
                <a href="#"><b>Ứng Viên</b></a>
            </div>
            <div class="register-box-body">
                <p class="login-box-msg">Đăng kí tài khoản tìm việc mới</p>
                <form action="{{route('post_register_candidate')}}" method="post">
                    @csrf
                ...
                <a href="{{route('candidate_login')}}" class="text-center">Tôi đã có tài khoản</a>
            </div>
            <!-- /.form-box -->
        </div>
        <!-- /.register-box -->
