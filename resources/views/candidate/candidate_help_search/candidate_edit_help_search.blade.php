        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form class="form-horizontal" action="{{url('/')}}/ung-vien/sua-tro-giup-{{$id}}.html" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="box-body">
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label">Tiêu đề hồ sơ</label>
                                <div class="col-sm-10">
                                    <input name="title" type="text" class="form-control" id="name" placeholder="Tên Tìm Kiếm" value="{{old('name',$candidate_info['title'])}}" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select id="category" name="category" class="form-control select2" style="width: 100%;">
                                        ...
                                        <option value="{{$v->id}}" {{$candidate_info->category_id==$v->id?'selected':''}}>{{$v->name}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select id="level" name="level" class="form-control select2" style="width: 100%;">
                                        ...
                                        <option value="{{$k}}" {{(old("level",$candidate_info['level']) == $k ? "selected":"") }}>{{$v}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select id="experience" name="experience" class="form-control select2" style="width: 100%;">
                                        ...
                                        <option value="{{$k}}" {{(old("experience",$candidate_info['experience']) == $k ? "selected":"") }}>{{$v}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select id="slary" name="slary" class="form-control select2" style="width: 100%;">
                                        ...
                                        <option value="{{$k}}" {{(old("slary",$candidate_info['slary']) == $k ? "selected":"") }}>{{$v}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select id="city" name="city" class="form-control select2" style="width: 100%;">
                                        @foreach($city as $k=>$v)
                                        <option value="{{$k}}" {{(old("city",$candidate_info['city']) == $k ? "selected":"") }}>{{$v}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select id="status" name="status" class="form-control select2" style="width: 100%;">
                                        <option value="1" {{(old("status",$candidate_info['status']) == 1 ? "selected":"") }}>Cho phép tìm kiếm</option>
                                        <option value="0" {{(old("status",$candidate_info['status']) == 0 ? "selected":"") }}>Không cho phép tìm kiếm</option>
                                    </select>
