        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form class="form-horizontal" action="{{url('/')}}/admin/sua-tin-{{$id}}.html" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select id="input_category" class="form-control select2" name="category[]" multiple="multiple" data-placeholder="Chọn ngành, tối đa 5 ngành" style="width: 100%;">
                                    @if(count($category)>0)
...
<script>
    ...
    $("#tags").select2({
        ...
        data: [1,2,3],
        ajax: {
            url: '{{url('/')}}/admin/ajax-list-tags.html',
            dataType: 'json',
    ...
    $("#input_category").select2({
        ajax: {
            url: '{{url('/')}}/admin/ajax-list-category.html',
            dataType: 'json',
            processResults: function(data) {
                return {
                    results: data
