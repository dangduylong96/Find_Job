                        ...
                        <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12 hidden-sm hidden-xs">
                            <div class="jp_navi_right_btn_wrapper">
                                <ul>
                                    ...
                                    <a href="https://findjobiuh.000webhostapp.com/employer/dashboard.html" target="_blank"><button class="btn btn-danger btn-lg btn-block"><i class="fa fa-sign-in"></i>&nbsp; Quay lại trang nhà tuyển dụng</button></a>
                                    @else
                                    <a href="https://findjobiuh.000webhostapp.com/ung-vien/dashboard.html" target="_blank"><button class="btn btn-danger btn-lg btn-block"><i class="fa fa-sign-in"></i>&nbsp; Quay lại trang người tìm việc</button></a>
                                    @endif                                    
                                </ul>
                            </div>
                        </div>
